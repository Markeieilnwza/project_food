...
st.title("🔬 ML Stock Test — ทำนายราคาปิดหุ้นวันถัดไป")
...
@st.cache_resource
def load_model():
    """โหลดโมเดล Ensemble, Scaler และ Encoders ของหุ้น"""
    model = joblib.load(os.path.join(MODEL_DIR, "stock_ensemble_model.pkl"))
